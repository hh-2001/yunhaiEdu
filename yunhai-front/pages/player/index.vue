  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      ...
      <section class="content">
        ...
        <iframe name="myframe" id="myframe" :src=url frameborder="0" align="left"
          width="100%" height="100%" scrolling="no" marginWidth=0 marginHeight=0 class="iframesty"
...
export default {
  methods: {
    ...
    getCourseInfo() {
      courseApi.getFrontCourseInfo(this.course.courseId).then((resp) => {
        this.chapterList = resp.data.data.items
  ...
  mounted() {
    ...
    ////获取课程详细信息
    this.url = '/player/' + this.$route.params.vid;
    this.getCourseInfo();
    this.initComment();
