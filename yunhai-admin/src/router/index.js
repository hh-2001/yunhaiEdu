...
export const constantRoutes = [
  ...
  // 首页
  {
    ...
    children: [{
      ...
      meta: { title: '云海学院后台首页', icon: 'dashboard' }
    }]
  },
  //个人信息
  {
  ...
  //讲师管理
  {
    ...
    children: [
      ...
      },
      {
        path: 'listLevel',
        name: '讲师级别列表',
        component: () => import('@/views/edu/teacher/listLevel.vue'),
        meta: { title: '讲师级别列表', icon: 'tree' }
      },
      {
        path: 'saveLevel',
        name: '添加讲师级别',
        component: () => import('@/views/edu/teacher/saveLevel.vue'),
        meta: { title: '添加讲师级别', icon: 'tree' }
      },
      {
        path: 'editLevel/:id',
        name: 'EduLevelEdit',
        component: () => import('@/views/edu/teacher/saveLevel.vue'),
        meta: { title: '编辑讲师级别', noCache: true },
        hidden: true
      },
    ]
  },
