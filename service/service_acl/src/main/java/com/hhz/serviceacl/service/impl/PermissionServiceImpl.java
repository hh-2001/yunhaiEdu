...
import com.hhz.serviceacl.helper.MemuHelper;
import com.hhz.serviceacl.helper.PermissionHelper;
import com.hhz.serviceacl.mapper.PermissionMapper;
...
//        });
    ...
    //=========================给角色分配菜单=======================
    @Override
    public boolean saveRolePermissionRealtionShipGuli(String roleId, String[] permissionIds) {
        //roleId角色id
        //permissionId菜单id 数组形式
        System.out.println("菜单数量:  " + permissionIds.length);
        int res = rolePermissionService.removeByRoleId(roleId);
        //1 创建list集合，用于封装添加数据
        List<RolePermission> rolePermissionList = new ArrayList<>();
        //遍历所有菜单数组
